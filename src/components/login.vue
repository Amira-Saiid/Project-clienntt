<template>
  ...
  <div class="container-fluid" style="height:30%" id="test">
    <img src="../logo/whitelogotextt.png" alt="" id="text" class="mx-auto d-block pt-5">
    ...
    <div class="row pt-5 d-flex justify-content-center mt-5" >
      ...
      <div class="col-sm-3 mt-5 pr-0 pl-0 pb-0" id="form">
        <form @submit.prevent="login" class="pt-5"  >
          <h3 style="color:blue" class="text-center mb-5">Log in to your account</h3>
        <div class="form-group row d-flex justify-content-center pt-5" >
        <v-icon class="mdi mdi-email mr-1" large color="blue"></v-icon>
        <input 
          type="email"
          class="form-control"
      ...
      <v-icon class="mdi mdi-lock mr-1" large color="blue"></v-icon>
    ...
    <v-btn type="submit" class="white--text " style="width:30%;" color="blue"  :loading="loading">Log In</v-btn>
      </div>
       </form>
...
<div class="row text-center justify-content-center ">
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h3>Enter your desired product</h3>
      </div>
    </div>
  </div>
</div>
